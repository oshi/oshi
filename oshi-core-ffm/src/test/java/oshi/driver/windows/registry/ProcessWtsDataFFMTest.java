...
class ProcessWtsDataFFMTest {

    @Test
    void testQueryProcessWtsMapFromWMI() {
        int pid = new SystemInfo().getOperatingSystem().getProcessId();
        Map<Integer, WtsInfo> wtsMap = ProcessWtsDataFFM.queryProcessWtsMapFromWMI(Collections.singleton(pid));
