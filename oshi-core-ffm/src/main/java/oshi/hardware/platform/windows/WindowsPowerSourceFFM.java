...
import static oshi.ffm.platform.windows.PowrProfFFM.BATTERY_INFORMATION;
import static oshi.ffm.platform.windows.PowrProfFFM.BATTERY_MANUFACTURE_DATE;
import static oshi.ffm.platform.windows.PowrProfFFM.BATTERY_QUERY_INFORMATION;
import static oshi.ffm.platform.windows.PowrProfFFM.BATTERY_STATUS;
import static oshi.ffm.platform.windows.PowrProfFFM.BATTERY_WAIT_STATUS;
import static oshi.ffm.platform.windows.PowrProfFFM.OFF_BI_CAPABILITIES;
import static oshi.ffm.platform.windows.PowrProfFFM.OFF_BI_CHEMISTRY;
import static oshi.ffm.platform.windows.PowrProfFFM.OFF_BI_CYCLE;
import static oshi.ffm.platform.windows.PowrProfFFM.OFF_BI_DESIGNED;
import static oshi.ffm.platform.windows.PowrProfFFM.OFF_BI_FULL;
import static oshi.ffm.platform.windows.PowrProfFFM.OFF_BMD_DAY;
import static oshi.ffm.platform.windows.PowrProfFFM.OFF_BMD_MONTH;
import static oshi.ffm.platform.windows.PowrProfFFM.OFF_BMD_YEAR;
import static oshi.ffm.platform.windows.PowrProfFFM.OFF_BQI_ATRATE;
import static oshi.ffm.platform.windows.PowrProfFFM.OFF_BQI_LEVEL;
import static oshi.ffm.platform.windows.PowrProfFFM.OFF_BQI_TAG;
import static oshi.ffm.platform.windows.PowrProfFFM.OFF_BS_CAPACITY;
import static oshi.ffm.platform.windows.PowrProfFFM.OFF_BS_POWERSTATE;
import static oshi.ffm.platform.windows.PowrProfFFM.OFF_BS_RATE;
import static oshi.ffm.platform.windows.PowrProfFFM.OFF_BS_VOLTAGE;
import static oshi.ffm.platform.windows.PowrProfFFM.OFF_BWS_TAG;
import static oshi.ffm.platform.windows.SetupApiFFM.DIGCF_DEVICEINTERFACE;
import static oshi.ffm.platform.windows.SetupApiFFM.DIGCF_PRESENT;
import static oshi.ffm.platform.windows.SetupApiFFM.SP_DEVICE_INTERFACE_DATA;
import static oshi.ffm.platform.windows.WinNTFFM.FILE_ATTRIBUTE_NORMAL;
import static oshi.ffm.platform.windows.WinNTFFM.FILE_SHARE_READ;
import static oshi.ffm.platform.windows.WinNTFFM.FILE_SHARE_WRITE;
import static oshi.ffm.platform.windows.WinNTFFM.GENERIC_READ;
import static oshi.ffm.platform.windows.WinNTFFM.GENERIC_WRITE;
import static oshi.ffm.platform.windows.WinNTFFM.OPEN_EXISTING;
...
import oshi.ffm.platform.windows.com.GuidFFM;
                        ...
                        try (var _ = NativeHandle.of(hBattery, Kernel32FFM::CloseHandle)) {
                            ...
                            if (psTimeRemainingInstant <= 0 && psPowerUsageRate != 0) {
                                psTimeRemainingInstant = Math.max(0d,
                                        (psDischarging ? psCurrentCapacity : maxCapacitySafe - psCurrentCapacity)
