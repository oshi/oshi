...
import static oshi.ffm.platform.mac.CoreFoundation.kCFNumberSInt64Type;
import static oshi.ffm.platform.mac.CoreFoundation.kCFStringEncodingUTF8;
...
import static oshi.ffm.platform.mac.IOKitFunctions.IOIteratorNext;
import static oshi.ffm.platform.mac.IOKitFunctions.IOObjectConformsTo;
import static oshi.ffm.platform.mac.IOKitFunctions.IOObjectRelease;
import static oshi.ffm.platform.mac.IOKitFunctions.IORegistryEntryCreateCFProperties;
import static oshi.ffm.platform.mac.IOKitFunctions.IORegistryEntryCreateCFProperty;
import static oshi.ffm.platform.mac.IOKitFunctions.IORegistryEntryGetChildEntry;
import static oshi.ffm.platform.mac.IOKitFunctions.IORegistryEntryGetChildIterator;
import static oshi.ffm.platform.mac.IOKitFunctions.IORegistryEntryGetName;
import static oshi.ffm.platform.mac.IOKitFunctions.IORegistryEntryGetParentEntry;
import static oshi.ffm.platform.mac.IOKitFunctions.IORegistryEntryGetRegistryEntryID;
import static oshi.ffm.platform.mac.IOKitFunctions.IORegistryEntrySearchCFProperty;
