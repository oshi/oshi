...
import static oshi.ffm.platform.windows.WinNTFFM.OSVERSIONINFOEX;
import static oshi.ffm.platform.windows.WinNTFFM.OSVERSIONINFOEX_MAJOR_VERSION_OFFSET;
import static oshi.ffm.platform.windows.WinNTFFM.OSVERSIONINFOEX_MINOR_VERSION_OFFSET;
import static oshi.ffm.platform.windows.WinNTFFM.OSVERSIONINFOEX_PRODUCT_TYPE_OFFSET;
import static oshi.ffm.platform.windows.WinNTFFM.OSVERSIONINFOEX_SP_MAJOR_OFFSET;
import static oshi.ffm.platform.windows.WinNTFFM.VER_EQUAL;
import static oshi.ffm.platform.windows.WinNTFFM.VER_GREATER_EQUAL;
import static oshi.ffm.platform.windows.WinNTFFM.VER_MAJORVERSION;
import static oshi.ffm.platform.windows.WinNTFFM.VER_MINORVERSION;
import static oshi.ffm.platform.windows.WinNTFFM.VER_NT_WORKSTATION;
import static oshi.ffm.platform.windows.WinNTFFM.VER_PRODUCT_TYPE;
import static oshi.ffm.platform.windows.WinNTFFM.VER_SERVICEPACKMAJOR;
import static oshi.ffm.platform.windows.WinNTFFM.WIN32_WINNT_VISTA;
import static oshi.ffm.platform.windows.WinNTFFM.WIN32_WINNT_WIN10;
import static oshi.ffm.platform.windows.WinNTFFM.WIN32_WINNT_WIN7;
import static oshi.ffm.platform.windows.WinNTFFM.WIN32_WINNT_WIN8;
import static oshi.ffm.platform.windows.WinNTFFM.WIN32_WINNT_WINBLUE;
