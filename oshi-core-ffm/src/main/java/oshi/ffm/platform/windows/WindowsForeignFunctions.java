...
import static oshi.ffm.platform.windows.WinNTFFM.SE_PRIVILEGE_ENABLED;
import static oshi.ffm.platform.windows.WinNTFFM.TOKEN_PRIVILEGES;
import static oshi.ffm.platform.windows.WinNTFFM.TOKEN_PRIVILEGES_ATTRIBUTES_OFFSET;
import static oshi.ffm.platform.windows.WinNTFFM.TOKEN_PRIVILEGES_LUID_OFFSET;
import static oshi.ffm.platform.windows.WinNTFFM.TOKEN_PRIVILEGES_PRIVILEGE_COUNT_OFFSET;
