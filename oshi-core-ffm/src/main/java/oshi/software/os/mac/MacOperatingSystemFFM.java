...
import static oshi.ffm.platform.mac.MacSystem.PROC_PIDTASKINFO;
import static oshi.ffm.platform.mac.MacSystem.PROC_TASK_INFO;
import static oshi.ffm.platform.mac.MacSystem.PTI_THREADNUM;
import static oshi.ffm.platform.mac.MacSystem.TIMEVAL;
import static oshi.ffm.platform.mac.MacSystemFunctions.getpid;
