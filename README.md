...
Current Development (SNAPSHOT) downloads
  * JDK8: [oshi-core-6.1.5-SNAPSHOT](https://oss.sonatype.org/service/local/artifact/maven/redirect?r=snapshots&g=com.github.oshi&a=oshi-core&v=6.1.5-SNAPSHOT&e=jar)
  * JPMS: [oshi-core-java11-6.1.5-SNAPSHOT](https://oss.sonatype.org/service/local/artifact/maven/redirect?r=snapshots&g=com.github.oshi&a=oshi-core-java11&v=6.1.5-SNAPSHOT&e=jar)
