...
-   [#34](https://github.com/oshi/oshi/pull/34): Changed the return type of NetworkInterface method getMTU() from int to long and also in all of its operating system implementations. - [@Simba-97](https://github.com/Simba-97).
