...
-   [#1](https://github.com/oshi/oshi/pull/1): Changed the return type of the NetworkInterface method getMTU() from int to long in all its OS implementations - [@Simba-97](https://github.com/Simba-97).
