...
-   [#1732](https://github.com/oshi/oshi/pull/1732): Changed the return type of the NetworkInterface method getMTU() from int to long for all its OS implementations. - [@Simba-97](https://github.com/Simba-97).
