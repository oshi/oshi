 ...
 *
 * The references to the memory objects are released on access of
 * WeakMemoryHolder.
 */
public class WeakCleanerMemoryHolder {
    ReferenceQueue<Object> referenceQueue = new ReferenceQueue<Object>();
    IdentityHashMap<Reference<Object>, CleanerMemory> backingMap = new IdentityHashMap<Reference<Object>, CleanerMemory>();

    public synchronized void put(Object o, CleanerMemory m) {
        clean();
