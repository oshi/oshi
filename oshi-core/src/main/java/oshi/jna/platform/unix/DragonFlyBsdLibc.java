 ...
 * project.
 */
public interface DragonFlyBsdLibc extends CLibrary {
    DragonFlyBsdLibc INSTANCE = Native.load("c", DragonFlyBsdLibc.class);
    ...
    class DragonFlyBsdUtmpx extends Structure {
     ...
     * Not thread safe
     *
     * @return a {@link DragonFlyBsdUtmpx} on success, and NULL on failure (which includes the "record not found" case)
     */
    DragonFlyBsdUtmpx getutxent();
