...
public interface FileSystem {
    ...
    /**
     * The maximum number of open file descriptors per process. This returns the upper limit which applies for each
     * process. The actual limit may be lower if configured.
     *
