...
public class SolarisOSVersionInfoEx extends AbstractOSVersionInfoEx {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(SolarisOSVersionInfoEx.class);

    public SolarisOSVersionInfoEx() {
        this(null, null);
    }

    protected SolarisOSVersionInfoEx(String versionId, String codeName) {
    ...
    private void setVersionFromReleaseFiles() {
        ...
        String etcDistribRelease = SolarisOperatingSystem.getReleaseFilename();
