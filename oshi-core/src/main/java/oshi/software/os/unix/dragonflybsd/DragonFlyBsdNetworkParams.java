...
/**
 * DragonFlyBsdNetworkParams class.
 */
@ThreadSafe
final class DragonFlyBsdNetworkParams extends AbstractNetworkParams {

    private static final Logger LOG = LoggerFactory.getLogger(DragonFlyBsdNetworkParams.class);

    private static final DragonFlyBsdLibc LIBC = DragonFlyBsdLibc.INSTANCE;
