...
import oshi.driver.unix.dragonflybsd.disk.GeomDiskList;
import oshi.driver.unix.dragonflybsd.disk.GeomPartList;
 ...
 */
@ThreadSafe
public final class DragonFlyBsdHWDiskStore extends AbstractHWDiskStore {

    private DragonFlyBsdHWDiskStore(String name, String model, String serial, long size) {
    ...
    public static List<HWDiskStore> getDisks() {
        ...
        for (String line : iostat) {
            ...
            if (split.length > 6 && devices.contains(split[0])) {
                ...
                DragonFlyBsdHWDiskStore store = (storeInfo == null)
                        ? new DragonFlyBsdHWDiskStore(split[0], Constants.UNKNOWN, Constants.UNKNOWN, 0L)
                        : new DragonFlyBsdHWDiskStore(split[0], storeInfo.getA(), storeInfo.getB(), storeInfo.getC());
