 ...
 */
@ThreadSafe
public final class DragonFlyBsdPowerSource extends AbstractPowerSource {

    public DragonFlyBsdPowerSource(String psName, String psDeviceName, double psRemainingCapacityPercent,
    ...
    private static DragonFlyBsdPowerSource getPowerSource(String name) {
        String psName = name;
        ...
        return new DragonFlyBsdPowerSource(psName, psDeviceName, psRemainingCapacityPercent, psTimeRemainingEstimated,
