...
/**
 * DragonFlyBsd Usb Device
 */
@Immutable
public class DragonFlyBsdUsbDevice extends AbstractUsbDevice {

    public DragonFlyBsdUsbDevice(String name, String vendor, String vendorId, String productId, String serialNumber,
    ...
    /**
     * Recursively creates DragonFlyBsdUsbDevices by fetching information from maps to populate fields
     *
     ...
     * @return A DragonFlyBsdUsbDevice corresponding to this device
     */
    private static DragonFlyBsdUsbDevice getDeviceAndChildren(String devPath, String vid, String pid,
        ...
        sort(usbDevices);
        return new DragonFlyBsdUsbDevice(nameMap.getOrDefault(devPath, vendorId + ":" + productId),
