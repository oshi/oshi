 ...
 */
@Immutable
final class DragonFlyBsdFirmware extends AbstractFirmware {

    private final Supplier<Triplet<String, String, String>> manufVersRelease = memoize(
            DragonFlyBsdFirmware::readDmiDecode);
