 ...
 */
@ThreadSafe
final class DragonFlyBsdVirtualMemory extends AbstractVirtualMemory {

    private final DragonFlyBsdGlobalMemory global;

    private final Supplier<Long> used = memoize(DragonFlyBsdVirtualMemory::querySwapUsed, defaultExpiration());

    private final Supplier<Long> total = memoize(DragonFlyBsdVirtualMemory::querySwapTotal, defaultExpiration());

    private final Supplier<Long> pagesIn = memoize(DragonFlyBsdVirtualMemory::queryPagesIn, defaultExpiration());

    private final Supplier<Long> pagesOut = memoize(DragonFlyBsdVirtualMemory::queryPagesOut, defaultExpiration());

    DragonFlyBsdVirtualMemory(DragonFlyBsdGlobalMemory freeBsdGlobalMemory) {
