 ...
 * @author : BilalAM
 */
public class SolarisUser extends AbstractUser {
        private static final String WHO_AM_I = "whoami";
        private static final String GETENT_PASSWD = "getent passwd";
        private static String userName;
        private static String[] values;

        public SolarisUser(String userName, int userId, String homeDir, String realName) {
        ...
        public static SolarisUser getUser(){
              return new SolarisUser(values[0],Integer.parseInt(values[2]),values[5],values[4]);
        }
