 ...
 */
@Immutable
final class DragonFlyBsdGraphicsCard extends AbstractGraphicsCard {

    private static final String PCI_CLASS_DISPLAY = "0x03";

    /**
     * Constructor for DragonFlyBsdGraphicsCard
     *
     * @param name        The name
     ...
     * @param vram        The VRAM
     */
    DragonFlyBsdGraphicsCard(String name, String deviceId, String vendor, String versionInfo, long vram) {
     ...
     *
     * @return List of {@link DragonFlyBsdGraphicsCard} objects.
     */
        ...
        for (String line : devices) {
            if (line.contains("class=0x")) {
                ...
                if (PCI_CLASS_DISPLAY.equals(classCode)) {
                    cardList.add(new DragonFlyBsdGraphicsCard(name.isEmpty() ? Constants.UNKNOWN : name,
