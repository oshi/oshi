 ...
 */
@ThreadSafe
final class DragonFlyBsdGlobalMemory extends AbstractGlobalMemory {

    private final Supplier<Long> available = memoize(this::queryVmStats, defaultExpiration());

    private final Supplier<Long> total = memoize(DragonFlyBsdGlobalMemory::queryPhysMem);

    private final Supplier<Long> pageSize = memoize(DragonFlyBsdGlobalMemory::queryPageSize);
    ...
    private VirtualMemory createVirtualMemory() {
        return new DragonFlyBsdVirtualMemory(this);
    }
}
