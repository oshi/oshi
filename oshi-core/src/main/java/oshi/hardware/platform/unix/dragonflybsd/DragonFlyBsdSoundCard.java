 ...
 */
@Immutable
final class DragonFlyBsdSoundCard extends AbstractSoundCard {

    private static final String LSHAL = "lshal";

    /**
     * Constructor for DragonFlyBsdSoundCard.
     *
     * @param kernelVersion The version
     * @param name          The name
     * @param codec         The codec
     */
    DragonFlyBsdSoundCard(String kernelVersion, String name, String codec) {
