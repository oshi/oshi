 ...
 */
@Immutable
public class WindowsUsbDeviceJNA extends AbstractUsbDevice {

    private static final GUID GUID_DEVINTERFACE_USB_HOST_CONTROLLER = new GUID(
            "{3ABF6F2D-71C4-462A-8A92-1E6861E6AF27}");

    public WindowsUsbDeviceJNA(String name, String vendor, String vendorId, String productId, String serialNumber,
    ...
    private static List<UsbDevice> queryUsbDevices() {
        ...
        for (Integer controllerDevice : controllerDevices.getA()) {
            WindowsUsbDeviceJNA deviceAndChildren = queryDeviceAndChildren(controllerDevice, parentMap, nameMap,
    ...
    private static WindowsUsbDeviceJNA queryDeviceAndChildren(Integer device, Map<Integer, Integer> parentMap,
        ...
        for (Integer child : childDeviceSet) {
            WindowsUsbDeviceJNA deviceAndChildren = queryDeviceAndChildren(child, parentMap, nameMap, deviceIdMap,
        ...
        if (nameMap.containsKey(device)) {
            ...
            return new WindowsUsbDeviceJNA(name, mfg, vendorId, productId, serial, deviceId, childDevices);
        }
        return null;
    }
}
