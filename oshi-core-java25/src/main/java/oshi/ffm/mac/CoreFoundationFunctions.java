...
public final class CoreFoundationFunctions extends MacForeignFunctions {
    ...
    private static final SymbolLookup CF_LIBRARY = frameworkLookup("CoreFoundation");

    // CFAllocatorRef CFAllocatorGetDefault();

    private static final MethodHandle CFAllocatorGetDefault = LINKER
            .downcallHandle(CF_LIBRARY.findOrThrow("CFAllocatorGetDefault"), FunctionDescriptor.of(ADDRESS));
    ...
    private static final MethodHandle CFRelease = LINKER.downcallHandle(CF_LIBRARY.findOrThrow("CFRelease"),
    ...
    private static final MethodHandle CFRetain = LINKER.downcallHandle(CF_LIBRARY.findOrThrow("CFRetain"),
    ...
    private static final MethodHandle CFGetRetainCount = LINKER
            .downcallHandle(CF_LIBRARY.findOrThrow("CFGetRetainCount"), FunctionDescriptor.of(JAVA_LONG, ADDRESS));
    ...
    private static final MethodHandle CFCopyDescription = LINKER
            .downcallHandle(CF_LIBRARY.findOrThrow("CFCopyDescription"), FunctionDescriptor.of(ADDRESS, ADDRESS));
    ...
    private static final MethodHandle CFStringCreateWithCharacters = LINKER.downcallHandle(
            CF_LIBRARY.findOrThrow("CFStringCreateWithCharacters"),
    ...
    private static final MethodHandle CFStringGetLength = LINKER
            .downcallHandle(CF_LIBRARY.findOrThrow("CFStringGetLength"), FunctionDescriptor.of(JAVA_LONG, ADDRESS));
    ...
    private static final MethodHandle CFStringGetCString = LINKER.downcallHandle(
            CF_LIBRARY.findOrThrow("CFStringGetCString"),
    ...
    private static final MethodHandle CFStringGetMaximumSizeForEncoding = LINKER.downcallHandle(
            CF_LIBRARY.findOrThrow("CFStringGetMaximumSizeForEncoding"),
    ...
    private static final MethodHandle CFNumberGetType = LINKER.downcallHandle(CF_LIBRARY.findOrThrow("CFNumberGetType"),
    ...
    private static final MethodHandle CFNumberCreate = LINKER.downcallHandle(CF_LIBRARY.findOrThrow("CFNumberCreate"),
    ...
    private static final MethodHandle CFDataGetLength = LINKER.downcallHandle(CF_LIBRARY.findOrThrow("CFDataGetLength"),
            FunctionDescriptor.of(JAVA_LONG, ADDRESS));
    ...
    private static final MethodHandle CFDataGetBytePtr = LINKER
            .downcallHandle(CF_LIBRARY.findOrThrow("CFDataGetBytePtr"), FunctionDescriptor.of(ADDRESS, ADDRESS));
    ...
    private static final MethodHandle CFDataCreate = LINKER.downcallHandle(CF_LIBRARY.findOrThrow("CFDataCreate"),
            FunctionDescriptor.of(ADDRESS, ADDRESS, ADDRESS, JAVA_LONG));
    ...
    private static final MethodHandle CFBooleanGetValue = LINKER
            .downcallHandle(CF_LIBRARY.findOrThrow("CFBooleanGetValue"), FunctionDescriptor.of(JAVA_BYTE, ADDRESS));
    ...
    private static final MethodHandle CFArrayGetCount = LINKER.downcallHandle(CF_LIBRARY.findOrThrow("CFArrayGetCount"),
            FunctionDescriptor.of(JAVA_LONG, ADDRESS));
    ...
    private static final MethodHandle CFArrayGetValueAtIndex = LINKER.downcallHandle(
            CF_LIBRARY.findOrThrow("CFArrayGetValueAtIndex"), FunctionDescriptor.of(ADDRESS, ADDRESS, JAVA_LONG));
    ...
    private static final MethodHandle CFArrayCreate = LINKER.downcallHandle(CF_LIBRARY.findOrThrow("CFArrayCreate"),
    ...
    private static final MethodHandle CFDictionaryGetCount = LINKER
            .downcallHandle(CF_LIBRARY.findOrThrow("CFDictionaryGetCount"), FunctionDescriptor.of(JAVA_LONG, ADDRESS));
    ...
    private static final MethodHandle CFDictionaryGetValue = LINKER.downcallHandle(
            CF_LIBRARY.findOrThrow("CFDictionaryGetValue"), FunctionDescriptor.of(ADDRESS, ADDRESS, ADDRESS));
    ...
    private static final MethodHandle CFDictionaryGetValueIfPresent = LINKER.downcallHandle(
            CF_LIBRARY.findOrThrow("CFDictionaryGetValueIfPresent"),
    ...
    private static final MethodHandle CFDictionarySetValue = LINKER.downcallHandle(
            CF_LIBRARY.findOrThrow("CFDictionarySetValue"), FunctionDescriptor.ofVoid(ADDRESS, ADDRESS, ADDRESS));
    ...
    private static final MethodHandle CFDictionaryCreateMutable = LINKER.downcallHandle(
            CF_LIBRARY.findOrThrow("CFDictionaryCreateMutable"),
    ...
    private static final MethodHandle CFGetTypeID = LINKER.downcallHandle(CF_LIBRARY.findOrThrow("CFGetTypeID"),
            FunctionDescriptor.of(JAVA_LONG, ADDRESS));
    ...
    private static final MethodHandle CFLocaleCopyCurrent = LINKER
            .downcallHandle(CF_LIBRARY.findOrThrow("CFLocaleCopyCurrent"), FunctionDescriptor.of(ADDRESS));
    ...
    private static final MethodHandle CFDateFormatterCreate = LINKER.downcallHandle(
            CF_LIBRARY.findOrThrow("CFDateFormatterCreate"),
    ...
    private static final MethodHandle CFDateFormatterGetFormat = LINKER.downcallHandle(
            CF_LIBRARY.findOrThrow("CFDateFormatterGetFormat"), FunctionDescriptor.of(ADDRESS, ADDRESS));
    ...
    private static final MethodHandle CFArrayGetTypeID = LINKER
            .downcallHandle(CF_LIBRARY.findOrThrow("CFArrayGetTypeID"), FunctionDescriptor.of(JAVA_LONG));
    ...
    private static final MethodHandle CFBooleanGetTypeID = LINKER
            .downcallHandle(CF_LIBRARY.findOrThrow("CFBooleanGetTypeID"), FunctionDescriptor.of(JAVA_LONG));
    ...
    private static final MethodHandle CFDataGetTypeID = LINKER.downcallHandle(CF_LIBRARY.findOrThrow("CFDataGetTypeID"),
    ...
    private static final MethodHandle CFDateGetTypeID = LINKER.downcallHandle(CF_LIBRARY.findOrThrow("CFDateGetTypeID"),
            FunctionDescriptor.of(JAVA_LONG));
    ...
    private static final MethodHandle CFDictionaryGetTypeID = LINKER
            .downcallHandle(CF_LIBRARY.findOrThrow("CFDictionaryGetTypeID"), FunctionDescriptor.of(JAVA_LONG));
    ...
    private static final MethodHandle CFNumberGetTypeID = LINKER
            .downcallHandle(CF_LIBRARY.findOrThrow("CFNumberGetTypeID"), FunctionDescriptor.of(JAVA_LONG));
    ...
    private static final MethodHandle CFStringGetTypeID = LINKER
            .downcallHandle(CF_LIBRARY.findOrThrow("CFStringGetTypeID"), FunctionDescriptor.of(JAVA_LONG));
