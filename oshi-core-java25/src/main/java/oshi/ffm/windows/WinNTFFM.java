...
public final class WinNTFFM {
    ...
    public static final GroupLayout LUID = MemoryLayout.structLayout(JAVA_INT.withName("LowPart"),
    ...
    // DWORD Attributes;
    // }
    public static final GroupLayout LUID_AND_ATTRIBUTES = MemoryLayout.structLayout(LUID.withName("Luid"),
    ...
    public static final GroupLayout TOKEN_PRIVILEGES_1 = MemoryLayout.structLayout(JAVA_INT.withName("PrivilegeCount"),
