...
public final class GuidFFM {
     ...
     * @return a memory segment containing the GUID
     */
    public static MemorySegment create(Arena arena, int data1, int data2, int data3,
            int d4_0, int d4_1, int d4_2, int d4_3, int d4_4, int d4_5, int d4_6, int d4_7) {
        byte[] data4 = new byte[] {
    ...
    public static MemorySegment CLSID_WbemLocator(Arena arena) {
        return create(arena, 0x4590f811, 0x1d3a, 0x11d0,
    ...
    public static MemorySegment IID_IWbemLocator(Arena arena) {
        return create(arena, 0xdc12a687, 0x737f, 0x11cf,
    ...
    public static MemorySegment IID_IUnknown(Arena arena) {
        return create(arena, 0x00000000, 0x0000, 0x0000,
