...
public final class NtDllFFM extends WindowsForeignFunctions {
    ...
    public static final StructLayout UNICODE_STRING = structLayout(
            JAVA_SHORT.withName("Length"),
            JAVA_SHORT.withName("MaximumLength"),
            paddingLayout(4), // alignment padding
    ...
    // CURDIR structure
    public static final StructLayout CURDIR = structLayout(
            UNICODE_STRING.withName("DosPath"),
            ADDRESS.withName("Handle")
    );

    // STRING structure for ANSI strings
    public static final StructLayout STRING = structLayout(
            JAVA_SHORT.withName("Length"),
            JAVA_SHORT.withName("MaximumLength"),
            paddingLayout(4),
            ADDRESS.withName("Buffer")
    ...
    public static final StructLayout RTL_DRIVE_LETTER_CURDIR = structLayout(
            JAVA_SHORT.withName("Flags"),
            JAVA_SHORT.withName("Length"),
            JAVA_INT.withName("TimeStamp"),
            STRING.withName("DosPath")
    );

    // PROCESS_BASIC_INFORMATION structure (48 bytes on 64-bit)
    public static final StructLayout PROCESS_BASIC_INFORMATION_STRUCT = structLayout(
            ADDRESS.withName("Reserved1"),
            ADDRESS.withName("PebBaseAddress"),
            sequenceLayout(4, ADDRESS).withName("Reserved2")
    );
    ...
    public static final StructLayout PEB = structLayout(
            sequenceLayout(4, JAVA_INT).withName("pad"), // 16 bytes of padding (InheritedAddressSpace, ReadImageFileExecOptions, BeingDebugged, BitField, Mutant)
    ...
    public static final StructLayout RTL_USER_PROCESS_PARAMETERS = structLayout(
            JAVA_INT.withName("MaximumLength"),
            JAVA_INT.withName("Length"),
            JAVA_INT.withName("Flags"),
            JAVA_INT.withName("DebugFlags"),
            ADDRESS.withName("ConsoleHandle"),
            JAVA_INT.withName("ConsoleFlags"),
            paddingLayout(4),
            ADDRESS.withName("StandardInput"),
            ADDRESS.withName("StandardOutput"),
            ADDRESS.withName("StandardError"),
            CURDIR.withName("CurrentDirectory"),
            ...
            JAVA_INT.withName("StartingX"),
            JAVA_INT.withName("StartingY"),
            JAVA_INT.withName("CountX"),
            JAVA_INT.withName("CountY"),
            JAVA_INT.withName("CountCharsX"),
            JAVA_INT.withName("CountCharsY"),
            JAVA_INT.withName("FillAttribute"),
            JAVA_INT.withName("WindowFlags"),
            JAVA_INT.withName("ShowWindowFlags"),
            paddingLayout(4),
            ...
            JAVA_LONG.withName("EnvironmentSize"),
            JAVA_LONG.withName("EnvironmentVersion"),
            ADDRESS.withName("PackageDependencyData"),
            JAVA_INT.withName("ProcessGroupId"),
            JAVA_INT.withName("LoaderThreads"),
            UNICODE_STRING.withName("RedirectionDllName"),
            UNICODE_STRING.withName("HeapPartitionName"),
            JAVA_LONG.withName("DefaultThreadpoolCpuSetMasks"),
    ...
    private static final MethodHandle NtQueryInformationProcess = downcall(NTDLL, "NtQueryInformationProcess",
