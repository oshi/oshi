...
import static oshi.ffm.mac.MacSystem.PROC_PIDPATHINFO_MAXSIZE;
import static oshi.ffm.mac.MacSystem.PROC_PIDTASKALLINFO;
import static oshi.ffm.mac.MacSystem.PROC_PIDVNODEPATHINFO;
import static oshi.ffm.mac.MacSystem.RUSAGE_INFO_V2;
...
import static oshi.ffm.mac.MacSystem.PBI_NFILES;
import static oshi.ffm.mac.MacSystem.PBI_PPID;
import static oshi.ffm.mac.MacSystem.PBI_START_TVSEC;
import static oshi.ffm.mac.MacSystem.PBI_START_TVUSEC;
import static oshi.ffm.mac.MacSystem.PBI_STATUS;
import static oshi.ffm.mac.MacSystem.PBI_UID;
import static oshi.ffm.mac.MacSystem.PBSD;
import static oshi.ffm.mac.MacSystem.PROC_BSD_INFO;
import static oshi.ffm.mac.MacSystem.PROC_TASK_ALL_INFO;
import static oshi.ffm.mac.MacSystem.PROC_TASK_INFO;
import static oshi.ffm.mac.MacSystem.PTINFO;
import static oshi.ffm.mac.MacSystem.PTI_CSW;
import static oshi.ffm.mac.MacSystem.PTI_FAULTS;
import static oshi.ffm.mac.MacSystem.PTI_PAGEINS;
import static oshi.ffm.mac.MacSystem.PTI_PRIORITY;
import static oshi.ffm.mac.MacSystem.PTI_RESIDENT_SIZE;
import static oshi.ffm.mac.MacSystem.PTI_THREADNUM;
import static oshi.ffm.mac.MacSystem.PTI_TOTAL_SYSTEM;
import static oshi.ffm.mac.MacSystem.PTI_TOTAL_USER;
import static oshi.ffm.mac.MacSystem.PTI_VIRTUAL_SIZE;
...
import static oshi.ffm.mac.MacSystem.RUSAGEINFOV2;
import static oshi.ffm.mac.MacSystem.VIP_PATH;
import static oshi.ffm.mac.MacSystem.VNODE_INFO_PATH;
import static oshi.ffm.mac.MacSystem.VNODE_PATH_INFO;
