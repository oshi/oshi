 ...
 * <p>
 * Mirrors {@link MacOSFileStore} but {@link #updateAttributes()} delegates to
 * {@link MacFileSystemFFM#getFileStoreMatching} rather than the JNA-based {@code MacFileSystem}.
 */
@ThreadSafe
public class MacOSFileStoreFFM extends AbstractOSFileStore {
