...
public abstract class FormatUtil
{
    ...
    /**
     * Added these variable for easier reading Using the IEC Standard for naming the units.
    ...
    /**
     * Format bytes into a rounded string representation using IEC standard (matches Mac/Linux). To match Windows
     * displays for KB, MB and GB, users can edit the returned string to display the (incorrect) JEDEC units.
     * 
     * @param bytes Bytes.
    ...
    public static String formatBytes( long bytes )
    {
        ...
        else if ( bytes < mebiByte && bytes % kibiByte == 0 )
        { // KiB
        ...
        else if ( bytes < gibiByte && bytes % mebiByte == 0 )
        { // MiB
        ...
        else if ( bytes % gibiByte == 0 && bytes < tebiByte )
        { // GiB
        ...
        else if ( bytes % tebiByte == 0 && bytes < pebiByte )
        { // TiB
        ...
        else if ( bytes % pebiByte == 0 && bytes < exbiByte )
        { // PiB
    ...
    public static String formatHertz( long hertz )
    {
        ...
        else if ( hertz < megaHertz && hertz % kiloHertz == 0 )
        { // KHz
        ...
        else if ( hertz < gigaHertz && hertz % megaHertz == 0 )
        { // MHz
        ...
        else if ( hertz < teraHertz && hertz % gigaHertz == 0 )
        { // GHz
        ...
        else if ( hertz < petaHertz && hertz % teraHertz == 0 )
        { // THz
        ...
        else if ( hertz < exaHertz && hertz % petaHertz == 0 )
        { // EHz
