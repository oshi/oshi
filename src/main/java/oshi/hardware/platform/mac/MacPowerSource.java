    ...
    implements PowerSource
{
    ...
    public static PowerSource[] getPowerSources()
    {
        ...
        for ( int ps = 0; ps < powerSourcesCount; ps++ )
        {
            ...
            Pointer isPresentRef =
                CoreFoundation.INSTANCE.CFDictionaryGetValue( dictionary, IOKit.IOPS_IS_PRESENT_KEY );
            ...
            psList.add( new MacPowerSource( nameBuf.getString( 0 ),
                                            (double) currentCapacity.getValue() / maxCapacity.getValue(),
                                            timeRemaining ) );
        }
        // Release the blob
