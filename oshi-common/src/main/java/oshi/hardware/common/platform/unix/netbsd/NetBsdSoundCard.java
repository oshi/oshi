 ...
 */
@Immutable
final class NetBsdSoundCard extends AbstractSoundCard {
    ...
    /**
     * Constructor for NetBsdSoundCard.
     *
     * @param kernelVersion The version
     * @param name          The name
     * @param codec         The codec
     */
    NetBsdSoundCard(String kernelVersion, String name, String codec) {
    ...
    public static List<SoundCard> getSoundCards() {
        ...
        for (Entry<String, String> entry : nameMap.entrySet()) {
            soundCards.add(new NetBsdSoundCard(versionMap.get(entry.getKey()), entry.getValue(),
