...
class AbstractGraphicsCardTest {
    ...
    @Test
    void testGetters() {
        AbstractGraphicsCard gpu = new StubGraphicsCard(-1d, -1d, -1L, -1L, -1d);
        assertThat(gpu.getName(), is("Test GPU"));
        assertThat(gpu.getDeviceId(), is("0xDEAD"));
        assertThat(gpu.getVendor(), is("TestVendor"));
        assertThat(gpu.getVersionInfo(), is("v1.0"));
        assertThat(gpu.getVRam(), is(8L * 1024 * 1024 * 1024));
    }
